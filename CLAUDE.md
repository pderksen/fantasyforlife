...
**Styling**:
- Class constants at top of `html.ts` keep markup DRY (`CELL`, `TH`, `TABLE_WRAP`, `PILL_LINK`, `PILL_ACTIVE`, `SECTION_H2`, `TP_TH`, `TP_TD`)
